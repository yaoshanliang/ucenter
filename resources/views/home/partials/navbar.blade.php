<div class="navbar-header">
    ...
    @if (!(('developer' == Session::get('current_role')['name']) || ('admin' == Session::get('current_role')['name'])))
    ...
    @else
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <a  href="#" class="dropdown-toggle navbar-brand" data-toggle="dropdown">{{ Cache::get(Config::get('cache.settings') . 'site_home_name') }}<span class="caret"></span></a>
                <ul class="dropdown-menu" style="min-width: 100%;" role="menu">
                    <li><a  href={{ Cache::get(Config::get('cache.settings') . 'site_url') }}/admin>{{ Cache::get(Config::get('cache.settings') . 'site_admin_name') }}</a></li>
                </ul>
            </li>
        </ul>
    @endif
